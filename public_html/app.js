...
async function renderHome() {
  ...
  const mockReviews = [
    {
      ...
      text: 'Брали набор фиников на подарок — это просто восторг! Очень изысканное сочетание шоколада и орехов, хрустит невероятно.'
    },
    {
      name: 'Максим',
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Срок годности клубники в шоколаде — 24 часа. Трюфели и финики в шоколаде хранятся до 1 месяца при температуре от +15 до +20 °C.'
    },
    {
      ...
      <div class="heritage-grid">
        <div class="heritage-img-wrap">
          <div class="heritage-img-main">
            <img src="/assets/images/truffles.webp"
